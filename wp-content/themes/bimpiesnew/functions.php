...
add_filter( 'show_admin_bar', 'hide_admin_bar_from_front_end' );
 ...
 /**
    ...
    * 
    */
    function magicdesign_admin_menus() {
        add_menu_page('General Settings', 'General Settings', 8, 'md_page_general', 'theme_general_settings');
        //add_submenu_page('md_page_general','General Settings', 'General Settings', 8,'md_page_general', 'theme_general_settings');

    }
    add_action("admin_menu", "magicdesign_admin_menus");
    add_theme_support( 'post-thumbnails' );
    
    function theme_general_settings()
    {
        global $wpdb, $table_prefix;
        include 'admin/general_settings.php';
    }